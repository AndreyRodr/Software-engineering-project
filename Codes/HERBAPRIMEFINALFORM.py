    ...
    def verificaCredencial(self, credencial):
        for funcionario in self.funcionarios:
            if funcionario.senha == credencial:
                print(f"Credencial verificada! Funcionário: {funcionario.nome}")
                return True
...
class ControladorVendas:
    def __init__(self, bancoDeDados):
        ...
        self.credencial_padrao = "123456"  # Definindo a credencial padrão no código
    ...
    def registrarVenda(self):
        credencial = input("Digite sua credencial para realizar a venda: ")
